...
export default async argv => {
  ...
  if (argv.security != './security') {
    app.use('/security', express.static(
      path.join(argv.packageDir, argv.security_type, 'client'), staticPathOptions,
    ))
  }
  ...
  const ctx = {
    app, pagehandler, sitemaphandler, searchhandler, securityhandler,
    packageJson, authorized, admin, cors, log, argv, getOwner,
  }
